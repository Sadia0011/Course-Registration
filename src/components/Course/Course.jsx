...
const Course = ({course,handleTakenCourses}) => {
    ...
    return (
        <div className='drop-shadow-xl bg-slate-100 p-2 border-none'>
            ...
            <p className='font-normal text-sm my-1'>{description}</p>
            ...
            <button onClick={()=>handleTakenCourses(course)} className='w-full bg-blue-600 text-white rounded-lg p-2 mt-2'>Select</button>
        </div>
    );
};
Course.propTypes={
